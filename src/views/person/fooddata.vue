            ...
            <div v-if="list.length > 0">
              ...
              >
                ...
                >
                  ...
                  <el-descriptions-item label="状态" width="20%">
                    {{ index.result }}
                  </el-descriptions-item>
                  ...
                  <el-descriptions-item  label="图片" width="30%">
                    <!-- {{ index.result }} -->
                    <img
                    v-if="index.picurl != null && index.picurl != ''"
                      :src="index.picurl"
...
onMounted(() => {
  ...
  Api.findonefoodcheck(user[0].name)
    .then((data) => {
      console.log(data);
      Object.assign(state.list, data.rows);
      state.totalCount = data.rows.length;
    })
    .catch((err) => {
      console.log(err);
    });
