          ...
          <el-col :span="14"
            ...
            >
              ...
              <el-table-column label="ID" prop="id" width="80" sortable fixed>
                ...
                <el-table-column label="食物名称" width="160" prop="name">
                </el-table-column>
                <el-table-column label="问题描述" width="280" prop="state">
                </el-table-column>
                <el-table-column label="提交人" width="120" prop="author">
                </el-table-column>
      ...
      <el-dialog v-model="updateDialog" title="反馈信息">
        <el-form :model="course" label-width="120px">
          <el-form-item label="食物ID">
            <el-input v-model="course.food_id" disabled />
          </el-form-item>
          ...
          <el-form-item label="描述">
            <el-input v-model="course.state" disabled type="textarea"/>
          </el-form-item>
          <el-form-item label="提交人ID">
            <el-input v-model="course.author_id" disabled />
          </el-form-item>
          <el-form-item label="提交人">
            <el-input v-model="course.author" disabled />
          </el-form-item>
